...
import type { TerminalScrollAnchor } from "./capture-terminal-scroll-anchor";
import { captureTerminalScrollAnchor } from "./capture-terminal-scroll-anchor";
import { restoreTerminalScrollAnchor } from "./restore-terminal-scroll-anchor";
