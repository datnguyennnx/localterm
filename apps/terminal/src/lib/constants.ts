...
export const DEFAULT_TERMINAL_PADDING_X_PX = 8;
export const DEFAULT_TERMINAL_PADDING_Y_PX = 8;
export const TERMINAL_PADDING_MIN_PX = 0;
export const TERMINAL_PADDING_MAX_PX = 48;
export const TERMINAL_PADDING_STEP_PX = 1;
export const OUTER_PADDING_X_STORAGE_KEY = "localterm:outer-padding-x";
export const OUTER_PADDING_Y_STORAGE_KEY = "localterm:outer-padding-y";
export const DEFAULT_OUTER_PADDING_X_PX = 12;
export const DEFAULT_OUTER_PADDING_Y_PX = 12;
export const OUTER_PADDING_MIN_PX = 0;
export const OUTER_PADDING_MAX_PX = 48;
export const OUTER_PADDING_STEP_PX = 1;
